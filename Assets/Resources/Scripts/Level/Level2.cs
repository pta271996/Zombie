...
public class Level2 : Singleton<Level2>, RandomInterface{
	...
	void summonMetalBlock (int lineNumber, float distancePerOne){

		//1 cai o line 3 
		float posY = ObstacleManager.Instance.maxYPosition -  2 * distancePerOne; //vi tri line ( tu 1 ,2 ,... lineNumber-1)
		summonAObstacle(2,1,-4.0f, posY);
		//1 cai o line 6
		posY = ObstacleManager.Instance.maxYPosition -  5 * distancePerOne; //vi tri line ( tu 1 ,2 ,... lineNumber-1)
		summonAObstacle(5,1,-3.0f, posY);
		//1 cai o line 4
		posY = ObstacleManager.Instance.maxYPosition -  3 * distancePerOne; //vi tri line ( tu 1 ,2 ,... lineNumber-1)
		summonAObstacle(3,1,2.0f, posY);
		//1 cai o line 7
		posY = ObstacleManager.Instance.maxYPosition -  6 * distancePerOne; //vi tri line ( tu 1 ,2 ,... lineNumber-1)
		summonAObstacle(6,1,3.0f, posY);
